...
import "./Course.css";
import Navbar from "../courses/C_Navbar.js";
import Faq from './C_Faq.js';
import Footer from "../footer/Footer.js";
import Details from './C_Details.js';
import Stages from './C_Stages';
// import { ContactUs } from './C_ContactUs.js';
import  Popup  from './Popup3.js';
import Timeline from './C_Timeline.js';
...
const scrollToTop = () => {
  ...
  return (
    ...
    <div class="section-content">
      <h1 class="title">Courses 2024</h1>
      <p class="description">Welcome to Strategyz+, your comprehensive guide to
acing B.Tech placements. This course is designed to
equip you with the necessary skills and knowledge to
excel in programming languages and development,
setting a solid foundation for your B.Tech placements.
The course includes certification upon completion.
</p>
